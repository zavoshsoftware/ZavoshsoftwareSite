...
namespace Models
{
    public class PageGroup:BaseEntity
    {
        ...
        public virtual PageGroup Parent { get; set; }
        public virtual ICollection<PageGroup> PageGroups { get; set; }
        public virtual ICollection<Page> Pages { get; set; }
        internal class Configuration : EntityTypeConfiguration<PageGroup>
        {
            public Configuration()
            {
                HasOptional(p => p.Parent)
                    .WithMany(t => t.PageGroups)
